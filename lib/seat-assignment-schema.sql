-- Schema for Event Seat Assignment System
...
-- Student seat registrations (when students register for assigned seats)
...
-- RLS Policies for seat assignments
...
CREATE INDEX idx_seat_assignments_event ON seat_assignments(event_id);
CREATE INDEX idx_seat_assignments_dept_year ON seat_assignments(department, year, gender);
CREATE INDEX idx_student_registrations_event ON student_seat_registrations(event_id);
CREATE INDEX idx_student_registrations_student ON student_seat_registrations(student_id);
